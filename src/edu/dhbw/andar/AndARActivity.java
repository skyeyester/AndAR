...
public abstract class AndARActivity extends Activity implements Callback, UncaughtExceptionHandler{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //get the assets folder in the .apk package
        res = getResources();
        
        artoolkit = new ARToolkit(res, getFilesDir(), camStatus);
        setFullscreen();
		...
		//Log.i("AndARActivity", "AndARActivity onCreate previewSurface setZOrderOnTop false");
		
        glSurfaceView = new GLSurfaceView(this);
        glSurfaceView.setZOrderOnTop(true);
        Log.i("AndARActivity", "AndARActivity onCreate glSurfaceView setZOrderOnTop true");
    ...
    protected void onPause() {
    	Log.i("AndARActivity", "AndARActivity onPause start");
    	mPausing = true;
        ...
        super.onPause();
        this.finish();
        Log.i("AndARActivity", "AndARActivity onPause finish");
    }
    
    @Override
    protected void onDestroy() {
    	Log.i("AndARActivity", "AndARActivity onDestroy start");
    	super.onDestroy();    	
    	System.runFinalization();
    	if(Config.DEBUG){
    		Debug.stopMethodTracing();
    	}
    	Log.i("AndARActivity", "AndARActivity onDestroy finish");
    }
    ...
    public void startPreview() {
    	...
    	camStatus.height = camPar.getPreviewSize().height;
    	camStatus.width = camPar.getPreviewSize().width;
    }
