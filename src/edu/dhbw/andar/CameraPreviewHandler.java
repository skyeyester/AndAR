...
public class CameraPreviewHandler implements PreviewCallback {
	...
	public synchronized void onPreviewFrame(byte[] data, Camera camera) {
			...
			//Log.d("onPreviewFrame","width="+par.getPreviewSize().width);
			//Log.d("onPreviewFrame","high="+par.getPreviewSize().height);
			///Log.d("onPreviewFrame","Before convert size="+data.length);
			convWorker.nextFrame(data);
			//Log.d("onPreviewFrame","After convert size="+data.length);
	...
	class ConversionWorker extends Thread {
		...
		public synchronized void run() {	
			...
			while(true) {
				...
				Log.i("CameraPreviewHandler", "CameraPreviewHandler");
				yield();
			}
		}
	...
	class AutoFocusHandler extends Thread implements AutoFocusCallback, MarkerVisibilityListener {
		...
		public void makerVisibilityChanged(boolean visible) {
			...
			Log.i(" AutoFocusHandler","makerVisibilityChanged");
			if(!visible) {
				long currTime = System.currentTimeMillis();
